...
// Class representing a product in the supermarket
class Product {
    String name;
    int price;
...
class Customer {
    ...
    public void checkout() {
        ...
        // Calculate total and make it effectively final
        ...
        payButton.addActionListener(e -> {
            // Clear cart and dispose of the current frame
            cart.clear();
            frame.dispose();
    
            // Show Thank You GUI after payment
    ...
    // Method to display the Thank You GUI
...
// Main class for the Supermarket Management System
public class SupermarketManagementSystem {
    private ProductList productList = new ProductList();
    private Admin admin;

    public SupermarketManagementSystem() {
        // Initialize admin with a username and password
    ...
    public static void main(String[] args) {
        ...
        // Main menu for choosing between admin and customer
        while (true) {
            ...
            if (mainChoice == 1) {
                ...
                while (true) {
                    ...
                    if (choice == 0) break; // Exit admin menu
                }
                ...
                // Customer shopping functionality
                while (true) {
                    System.out.println("\nCustomer Menu:");
